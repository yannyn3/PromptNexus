...
    console.log('开始从Notion获取数据，数据库ID:', notionDatabaseId);
...
    console.log(`从Notion获取了 ${response.results.length} 个提示词`);
...
    console.log(`数据处理完成: ${data.prompts.length} 个提示词, ${data.categories.length} 个分类`);
