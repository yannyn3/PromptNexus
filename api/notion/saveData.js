...
    console.log('开始保存数据到Notion，数据库ID:', notionDatabaseId);
...
    console.log(`要保存的数据: ${data.prompts.length} 个提示词`);
...
    console.log(`Notion数据库中已有 ${existingPages.results.length} 个页面`);
...
          console.log(`更新提示词: ${prompt.title} (ID: ${prompt.id})`);
          // 更新现有页面
...
        } else {
          console.log(`创建新提示词: ${prompt.title}`);
          // 创建新页面
...
    console.log('完成保存数据到Notion:', results);
